...
After you sign up, you will greeted with the home page:

.Home page after successful sign up
image::Signup.png[width="750"]
...
After you login, you will greeted with the home page:

.Home page after successful login
image::Login.png[width="750"]
// end::login[]
...
After you logout, you will be greeted with an empty page:

.Empty page after successful logout
image::Logout.png[width="750"]
// end::logout[]
