...
. The system should be useable by a user by a first timer with the help of the user guide.
. The system should work on both 32-bit and 64-bit environments.
. The system should only show data to the people with the appropriate roles
