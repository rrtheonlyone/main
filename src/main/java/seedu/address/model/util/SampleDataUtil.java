    ...
    public static Order[] getSampleOrders() {
        Order[] orders = new Order[]{
            ...
            new Order(new Name("Bernice Yu"), new Phone("99272758"),
                        new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new OrderDate("02-10-2018 10:00:00"),
                        getFoodSet("Chicken Rice")),
            new Order(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                        new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new OrderDate("03-10-2018 14:00:00"),
            ...
            new Order(new Name("Irfan Ibrahim"), new Phone("92492021"),
                        new Address("Blk 47 Tampines Street 20, #17-35"), new OrderDate("05-10-2018 10:00:00"),
