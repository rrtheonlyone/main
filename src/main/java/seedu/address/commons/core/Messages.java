...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_ROUTE_DISPLAYED_INDEX = "The route index provided is invalid";
    ...
    public static final String MESSAGE_INVALID_DELIVERYMAN_DISPLAYED_INDEX = "The deliveryman index provided is invalid";
