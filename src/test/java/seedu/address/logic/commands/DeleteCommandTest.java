...
public class DeleteCommandTest {
    ...
    private Model model = new ModelManager(getTypicalAddressBook(), getTypicalRouteList(), new UserPrefs());
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), model.getRouteList(), new UserPrefs());
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), model.getRouteList(), new UserPrefs());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();
