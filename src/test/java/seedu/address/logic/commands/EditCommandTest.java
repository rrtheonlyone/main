...
public class EditCommandTest {
    ...
    private Model model = new ModelManager(getTypicalAddressBook(), getTypicalDeliverymenList(), new UserPrefs());
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBook()), new DeliverymenList(model.getDeliverymenList()), new UserPrefs());
