...
public class ModelManagerTest {
    ...
    public void equals() {
        ...
        modelManager = new ModelManager(orderBook, usersList, userPrefs);
        ModelManager modelManagerCopy = new ModelManager(orderBook, usersList, userPrefs);
        ...
        assertFalse(modelManager.equals(new ModelManager(differentOrderBook, differentUsersList, userPrefs)));

        // different filteredList -> returns false
        String[] keywords = ALICE.getName().fullName.split("\\s+");
        modelManager.updateFilteredOrderList(new NameContainsKeywordsPredicate(Arrays.asList(keywords)));
        assertFalse(modelManager.equals(new ModelManager(orderBook, usersList, userPrefs)));
        ...
        assertTrue(modelManager.equals(new ModelManager(orderBook, usersList, differentUserPrefs)));
    }
}
